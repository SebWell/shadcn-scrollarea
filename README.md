# 🎨 Shadcn/UI ScrollArea for Weweb

Beautiful **ScrollArea component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-scrollarea`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The ScrollArea component will appear in your elements!
...
├── src/
│   ├── ScrollArea.vue    # Vue.js component
│   ├── cn.js            # CSS utility
